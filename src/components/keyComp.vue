<template>
  <div class="keyboard" ref="keyboard">
    ...
    <div class="row">
      <div
        class="key size-5 yellow stretch"
        data-code="ShiftLeft"
        data-macro="yellow:ShiftLeft"
      ></div>
      ...
      <div
        class="key size-3 yellow stretch"
        data-code="ShiftRight"
        data-macro="yellow:ShiftRight"
      ></div>
    ...
    <div class="row">
      ...
      <div
        class="key size-2 purple stretch"
        data-code="ContextMenu"
        data-macro="purple:ContextMenu"
      ></div>
...
function setKeyState(code, state) {
  ...
  if (ele) {
    ...
    keyboard.value.style.setProperty('--rot-x', `${rotation.x}deg`)
    keyboard.value.style.setProperty('--rot-y', `${rotation.y}deg`)
  }
}
...
.key {
  ...
  box-shadow: -5px -5px 10px hsl(0%, 0%, 100%, 0.01), -2px -2px 6px hsl(0%, 0%, 100%, 0.03),
    2px 2px 5px hsl(0, 0%, 0%, 0.3), 5px 5px 10px hsl(0, 0%, 0%, 0.3);
}
...
.key {
  ...
  &[data-selected]:not([data-selected='false']) {
    ...
    box-shadow: -5px -5px 10px hsl(0%, 0%, 100%, 0.01), -2px -2px 6px hsl(0%, 0%, 100%, 0.03),
      2px 2px 5px hsl(0, 0%, 0%, 0.3), 5px 5px 10px hsl(0, 0%, 0%, 0.3), 0px 2px 8px var(--color),
